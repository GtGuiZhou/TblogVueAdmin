...
SVGRenderer.prototype = {
	 ...
	 *
	 * @param {Object} color The color or common object
	 */
	color: function (color, elem, prop) {
		...
		if (gradName) {
			...
			// Check if a gradient object with the same common object is created within this renderer
			if (gradients[key]) {
				id = gradients[key].id;
...
Axis.prototype = {
	...
	/** 
	 * The default label formatter. The context is a special common object for the label.
	 */
...
Chart.prototype = {
	 ...
	 *
	 * @param {Object} options The common options
	...
	/**
	 * Create the Axis instances based on the common options
	 */
	getAxes: function () {
		var chart = this,
			options = this.options,
 ...
 * in various arrays.
 *
 * - First, series.options.data contains all the original common options for
...
Series.prototype = {
	...
	getAttribs: function () {
		...
		while (i--) {
			...
			// a specific marker common object is defined for the individual point:
			...
			// no marker common object is created: copy a reference to the series-wide
